...
from abstractAppShape import AbstractAppShape
from ParserL.ParserLists import ParserLists


class ParserApp(AbstractAppShape):

    _statusApp = []
    _fileForSerializing = r"C:\Users\Demonss\PycharmProjects\parserLists\ParserL\ParserAppMemory.json"
    _lastDatetime = None
    ...
    def __new__(cls):
        if not hasattr(cls, 'instance'):
            cls.instance = super(ParserApp, cls).__new__(cls)
        return cls.instance
